...
public class MainClass {
    public static void main(String[] args) throws Exception {
        Item item1 = new Item("5462124476768", "MILK 3,5", new BigDecimal("0.77"), BigDecimal.ONE, new BigDecimal("0.00"), new BigDecimal("0.095"));
        Item item2 = new Item("3424565473432", "ONION CHIPS", new BigDecimal("0.96"), BigDecimal.ONE, new BigDecimal("0.00"), new BigDecimal("0.095"));
        Item item3 = new Item("9029857145932", "MONSTER ENERGY", new BigDecimal("1.18"), BigDecimal.ONE, new BigDecimal("0.00"), new BigDecimal("0.095"));
        ...
        Company issuer1 = new Company("MARKET", "32156782", "5571693000");
        Company customer1 = new Company("COMPANY1", "39294857", "1456233000");
        Company customer2 = new Company("COMPANY2", "", "15768923000");

        Items items1 = new Items();
        Items items2 = new Items();
        Items items3 = new Items();

        Invoice invoice1 = new Invoice(issuer1, "New York", dateTime1, customer1, "Bl 151", items1, "cash", new BigDecimal("50"), "40ba076e64c94487d6fc72223389fcb2", "06a82a75-359c-4181-8cd7-25f8713e6860", "26400812165100476227200303115815");
        Invoice invoice2 = new Invoice(issuer1, "New York", dateTime2, customer2, "Bl 154", items2, "cash", new BigDecimal("1.20"), "da74f74ed1bd5e8e8d7f630035914c6a", "a2893481-bddc-4a61-73d0-3215e6795671", "26400812165400280059200304170342");
        Invoice invoice3 = new Invoice(issuer1, "New York", dateTime3, null, "Bl 153", items3, "cash", new BigDecimal("2.00"), "b9ac3f37f5615979d28a5ccaf25be793", "af661420-da22-43ac-865d-df7ab12eecfe", "26400812165300393071200306204358");
        ...
        Item item4 = new Item("6782940300238", "BANANA", new BigDecimal("1.2"), new BigDecimal("1.35"), new BigDecimal("0.00"), new BigDecimal("0.095"));
        ItemInternal iItem1 = new ItemInternal(item4, "fruit");

        Item item5 = new Item("8282309852456", "TOMATO", new BigDecimal("1.99"), new BigDecimal("0.935"), new BigDecimal("0.00"), new BigDecimal("0.095"));
        ItemInternal iItem2 = new ItemInternal(item4, "vegetable");

        Item item6 = new Item("1009837800998", "CHICKEN", new BigDecimal("5.95"), new BigDecimal("1.2"), new BigDecimal("0.00"), new BigDecimal("0.095"));
        ItemInternal iItem3 = new ItemInternal(item4, "meat");

        Item item7 = new Item("9943112789443", "CAKE", new BigDecimal("15") , BigDecimal.ONE, new BigDecimal("0.00"), new BigDecimal("0.095"));
